        ...
        <div class="container-fluid main d-flex flex-row">
            <div class="container-fluid">
                ...
                <div class="card container-fluid rating my-4 border-dark border-3 d-flex flex-row p-3">
                    <div class="py-2 d-flex flex-row" style="width: 65%;">
                        <img src="./imgs/profile.png" class="mx-2" width="20%" height="90%">
                        <div class="mx-2">
                            <?php
                    ...
                    <div class="p-2" style="width: 30%;">
                        <div class="text-center d-flex flex-column justify-content-center py-3">
                            <h4>Performance Rating:</h4>
                            <h6>This user has been rated a score of 5.0 by their employer</h5>
                        </div>
                    </div>
                </div>
                <!--Jobs applied by worker-->
                <div class="card container-fluid jobList my-4 border-dark border-3">
                    <h2 class="mx-2 my-3">Jobs You Have Applied</h2>
                    <div class="maxW h90 my-3 card border-dark border-2" style="background-color:whitesmoke;">
                        <iframe src="jobs_applied.php" height="100%" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
            <!--Recommended jobs-->
            <div class="container-fluid"> 
                <div class="card container-fluid jobEndorse my-4 border-dark border-3">
                    <h2 class="mx-2 my-3">Jobs For You</h2>
                    <div class="maxW h90 my-3 card border-dark border-2" style="background-color:whitesmoke;">
                        <iframe src="jobs_list.php" height="100%" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
