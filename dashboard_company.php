...
<body>
    ...
    <div class="container-fluid main d-flex flex-column">
        ...
        <div class="container-fluid">
            <form action="./company_ins.php" method="post">
                <div class="card container-fluid jobEndorse my-4 border-dark border-3">
                    <h2 class="mx-2 my-3">Company Name</h2>
                    <form action="job_search.html" method="post">
                        <input class="w-25" type="text" name="comp">
                    </form>
                    <div class="w-25 h90 my-3" style="float:right;">
